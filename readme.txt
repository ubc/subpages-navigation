...
**Please note: you need to copy a CSS file and an image file into your template folder. See the [installation instructions][2] for details.**
 ...
 [2]: http://wordpress.org/extend/plugins/subpages-navigation/installation/
...
Please note that you will likely have to tweak the CSS to make it work with your theme. You can do this by editing the subpages-navigation.css in your template directory and/or replacing image that shipped with the plugin. See the [styling guide][1] for detials. We know that this is not optimal, but please understand that it is very difficult to come up with a default stylesheet that works semmelessly across all themes. If you need help, please go to the WordPress forurm.
...
== Screenshots ==
1. The section widget admin interface.

2. A simple section widget.

3. Using HTML in section widget.

4. A fancy section widget.

5. Selecting arbitrary pages.

== Changelog ==
*   Version 2.01: first public release.
*   Version 2.02: fixed minor JavaScript bug.
*   Version 2.03: added install instructions for Wordpress 2.7.
